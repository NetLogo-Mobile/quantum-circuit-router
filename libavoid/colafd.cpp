...
void ConstrainedFDLayout::setAvoidNodeOverlaps(bool avoidOverlaps, std::vector<unsigned> rs)
{
    m_generateNonOverlapConstraints = avoidOverlaps;
    m_nonoverlap_exemptions->addExemptGroupOfRectangles(rs);
}
