...
// NOTE: This is an internal helper class that should not be used by the user.
//
// It is used by  to add additional functionality to libavoid
...
class AVOID_EXPORT Router {
    public:
         ...
         *  from  rather than write your own.  This is done so that 
         *  libavoid does not have to depend on .
         */
