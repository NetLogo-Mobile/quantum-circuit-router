...
namespace Avoid {
	...
	void ShapeConnectionPin::updatePositionAndVisibility(const double xOffset, const double yOffset, const ConnDirFlags directions) {
		if (m_x_offset == xOffset && m_y_offset == yOffset && m_visibility_directions == directions) return;
		m_x_offset = xOffset;
		m_y_offset = yOffset;
		m_visibility_directions = directions;
